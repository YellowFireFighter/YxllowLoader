    ...
    currentGameEvent_(0) // Initialize with invalid address
{
    ...
    try {
        ...
        // 3. Determine Offsets (hardcoded – no pattern scanning needed)
        ...
        Logger::Info("RLSDK: [Step 4/7] GNameTable OK – loaded " + std::to_string(gnames_.GetNameCount()) + " names.");
        ...
        Logger::Info("RLSDK: [Step 5/7] GObjectsTable OK – mapped "
